...
/* added by GCC SCIL front end */
/*
 * Get the data user code associated with a program item.
 */
void *ILProgramItemGetUserData(ILProgramItem *item);

/* added by GCC SCIL front end */
/*
 * Set the data user code wants to associate with a program item.
 */
void ILProgramItemSetUserData(ILProgramItem *item, void *userData);
...
#define	ILProgramItem_HasAttrs(item)	\
			(ILProgramItemNextAttribute((ILProgramItem *)(item), \
										(ILAttribute *)0) != 0)
/* added by GCC SCIL front end */
#define	ILProgramItem_UserData(item)	\
				(ILProgramItemGetUserData((ILProgramItem *)(item)))
